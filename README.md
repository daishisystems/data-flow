...
mvn compile exec:java -Dexec.mainClass=com.dataflow.sample.Payments -Dexec.args="--project=eshop-puddle --jobName=checkout-payments-dev --gcpTempLocation=gs://esw-checkout-dev/tmp/ --stagingLocation=gs://esw-checkout-dev/staging/ --region=europe-west1 --numWorkers=4 --inputTopic=projects/eshop-puddle/topics/payments-dev --deadLetterTopic=projects/eshop-puddle/topics/checkout-dead-letter-payments-dev --paymentMasterTopic=projects/eshop-puddle/topics/checkout-payment-master-dev --archiveTopic=projects/eshop-puddle/topics/checkout-payment-archive-dev --runner=DataflowRunner" -e
